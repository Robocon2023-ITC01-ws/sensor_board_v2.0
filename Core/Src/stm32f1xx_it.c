...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BTN11_Pin);
  HAL_GPIO_EXTI_IRQHandler(BTN12_Pin);
  HAL_GPIO_EXTI_IRQHandler(BTN13_Pin);
  HAL_GPIO_EXTI_IRQHandler(BTN14_Pin);
  HAL_GPIO_EXTI_IRQHandler(BTN15_Pin);
